 ...
 * e inicializa la variable userFullName y userKey 
...
function doView(owner, title){
  console.log("doView called with owner:", owner, "and title:", title);
...
/*
 * Esta función recibe la respuesta del CGI article.pl y muestra el formulario 
